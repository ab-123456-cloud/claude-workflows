...
- **A finished draft, concept, or prompt — on the table** → **`/scrutinize`**. Four passes — steelman, verify the load-bearing assumptions, multi-lens attack, referee report — ending in an earned verdict: sound, salvageable, or unsound.
